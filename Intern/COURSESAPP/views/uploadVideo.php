...
$displayVideoName = $_SESSION['displayVideoName'];
$course_id_forVideo = $_SESSION['course_id_forVideo'];

if (isset($_POST['submit'])) 
{
	$name = $_FILES['file']['name'];
	$temp = $_FILES['file']['tmp_name'];
	move_uploaded_file($temp, "../uploadedVideo/".$name);

	$conn = new Connection();
	$conn->createConnection();

	$result = $conn->executeQuery("INSERT INTO video (actualVideoName, displayVideoName, course_id) VALUES ('$name', '$displayVideoName', '$course_id_forVideo')");
	$lastId = -1;
	if($result)
	{
...
<body style="background-image: url(&quot;assets/img/star-sky.jpg&quot;);">
    ...
    <section style="height: 246px;">
        <h1 class="text-center text-white">Upload Video</h1>
    </section>
    <!-- Start: 1 Row 2 Columns -->
    <center>
    	<form action="uploadVideo.php" method="POST" enctype="multipart/form-data">
    	    <input class = "btn btn-secondary" type="file" name="file" id="videoName">
    	    <br><br>
